# Assets da marca — procedência

Nenhum destes arquivos foi recriado ou redesenhado. Todos foram **extraídos dos
originais** enviados pela marca e apenas recortados, aparados e otimizados para web.

**Fontes**

- `MB` — *Manual de Marca — RF Group (By Pedro T.)*
- `FD` — *Folder 2026 — Connect Academy* (p. 1 = capa/Connect Med, p. 2 = miolo)
...
| `badge-tributario.png` | FD p.2 — badge Connect Tributário | idem |
